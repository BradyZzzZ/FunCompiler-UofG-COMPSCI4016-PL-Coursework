...
public interface FunVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitRepeat(FunParser.RepeatContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code caseseq}
	 * labeled alternative in {@link FunParser#case_seq}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCaseseq(FunParser.CaseseqContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase(FunParser.CaseContext ctx);
	/**
	 * Visit a parse tree produced by the {@code rangeofint}
	 * labeled alternative in {@link FunParser#range}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRangeofint(FunParser.RangeofintContext ctx);
	/**
	 * Visit a parse tree produced by the {@code defaultcase}
	 * labeled alternative in {@link FunParser#default_case}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
